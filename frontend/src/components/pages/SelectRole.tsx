...
import icon_payroll from '../../imgs/icon_payroll.svg'
    ...
    <div className="flex items-center justify-center" style={{ background: '#FFFCF9', width: '100vw', height: '100vh' }}>
      <div className="text-center
        ...
        <Button onClick={() => saveValue('CASHIER')} name="CASHIER" value="CASHIER"
          className="shadow"
          style={{
            width: '300px', margin: '20px', borderRadius: '5px', padding: '20px', height: 'auto', fontSize: '22px', fontWeight: 'bold', color: '#683830'
        ...
        {admin &&
          <Button onClick={() => window.location.href = "/payroll/employee"} name="PAYROLL" value="PAYROLL"
            className="shadow"
            style={{
              width: '300px', margin: '20px', borderRadius: '5px', padding: '20px', height: 'auto', fontSize: '22px', fontWeight: 'bold', color: '#683830'
              , boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)'
          ...
          >
            <img src={icon_payroll} style={{ height: '150px', margin: '0 auto 30px' }} />
          Payroll
        </Button>
        }
        <Button onClick={() => {
